...
// Replace common
code = code.replace(/refresh: 'Refresh', email: 'Email',/, "refresh: 'Refresh', email: 'Email', or: 'OR', created: 'Created: ', published: 'Published', start_date: 'Start Date: ',");
code = code.replace(/refresh: 'Actualizar', email: 'Correo',/, "refresh: 'Actualizar', email: 'Correo', or: 'O', created: 'Creado: ', published: 'Publicado', start_date: 'Fecha de inicio: ',");
code = code.replace(/refresh: 'Atualizar', email: 'E-mail',/, "refresh: 'Atualizar', email: 'E-mail', or: 'OU', created: 'Criado: ', published: 'Publicado', start_date: 'Data de início: ',");
...
// Also need to add missing keys for status dict if they don't exist
code = code.replace(/rejected: 'Rejected'/g, "rejected: 'Rejected', published: 'Published'");
code = code.replace(/rejected: 'Rechazado'/g, "rejected: 'Rechazado', published: 'Publicado'");
code = code.replace(/rejected: 'Rejeitado'/g, "rejected: 'Rejeitado', published: 'Publicado'");
