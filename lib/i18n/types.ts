...
export interface Dictionary {
  ...
  auth: { signIn: string; signUp: string; createAccount: string; haveAccount: string; noAccount: string; firstName: string; lastName: string; roleTitle: string; termsText: string; signOut: string; email: string; password: string; accessDenied: string; pendingApproval: string; contactAdmin: string; };
