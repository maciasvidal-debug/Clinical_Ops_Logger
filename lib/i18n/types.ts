...
export interface Dictionary {
  ...
  reports: { title: string; subtitle: string; timeByProject: string; timeByCategory: string; noData: string; export: string; generateInsights: string; };
